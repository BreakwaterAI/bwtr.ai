(() => {
  ...
  function applyTheme(dark) {
    ...
    if (logo) {
      ...
      logo.srcset = `/assets/product-proof/brand-${variant}-v05-340.webp 340w, /assets/product-proof/brand-${variant}-v05-510.webp 510w, /assets/product-proof/brand-${variant}-v05-680.webp 680w`;
      logo.src = `/assets/product-proof/brand-${variant}-v05-340.webp`;
    }
    if (theme) {
